	...
	class TeraWallet_REST_Admin_Withdrawal_Controller extends TeraWallet_REST_Admin_Controller_Base {
		...
		protected function get_create_args() {
			return array(
				...
				'phone'            => array( 'required' => true, 'type' => 'string', 'description' => __( 'Contact phone number, in case staff need to reach the customer about this request.', 'woo-wallet' ), 'sanitize_callback' => 'sanitize_text_field' ),
